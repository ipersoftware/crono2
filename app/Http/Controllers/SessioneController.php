...
class SessioneController extends Controller
{
    ...
    private function valida(Request $request, bool $partial = false): array
    {
        ...
        return $request->validate([
            ...
            'tipo_conferma'                    => 'nullable|in:PRENOTAZIONE_AUTOMATICA,PRENOTAZIONE_DA_CONFERMARE,NESSUNA',
            'lista_attesa_finestra_conferma_ore' => 'nullable|integer|min:1|required_if:tipo_conferma,PRENOTAZIONE_DA_CONFERMARE',
